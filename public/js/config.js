...
const config = {
  video: {
    url: "", // Se asigna en initializeConfig
    currentQuality: "dash", // o "hls"
...
function initializeConfig() {
  ...
  // Centraliza la URL de vídeo
  config.video.url = `https://gdie2504.ltim.uib.es/videos/${city}/out/manifest.${
    config.video.currentQuality === "dash" ? "mpd" : "m3u8"
  }`;
